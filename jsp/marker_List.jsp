...
<%
	...
	String lat = request.getParameter("board_Latitude");
	String longt = request.getParameter("board_Longitude");
	...
	String query = "";
		...
		+ " from m_board as b, m_image as i where b.board_Latitude= "+lat+" and b.board_Longitude= "+longt+" and b.board_Seqno = i.image_bSeqno and board_DeleteDate is null order by board_Seqno desc";
