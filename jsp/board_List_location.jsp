...
<%
	...
	String str = request.getParameter("board_uSeqno");
	String query = "";

	if(str == null){
		//str = " where ";
		query="select board_Seqno, board_uSeqno, board_Title, board_Price, board_Content, board_Hit, "
		+ " image_String, board_Sido, board_Latitude, board_Longitude, board_isDone, "
		...
		+ " from m_board as b, m_image as i where b.board_Seqno = i.image_bSeqno and board_DeleteDate is null order by board_Seqno desc";
	}else{
		str = " where b.board_uSeqno = '"+str+"' and ";
		query="select board_Seqno, board_uSeqno, board_Title, board_Price, board_Content, board_Hit, "
		+ " image_String, board_Sido, board_Latitude, board_Longitude, board_isDone, "
		+ " (select count(like_Seqno) from m_likes, m_board where m_board.board_Seqno = m_likes.like_bSeqno and board_Seqno = b.board_Seqno), "
		+ " (select count(like_Seqno) from m_likes, m_board where m_board.board_Seqno = m_likes.like_bSeqno and board_Seqno = b.board_Seqno and like_uSeqno = "+user_Seqno+")"
		+ " from m_board as b, m_image as i "+str+" b.board_Seqno = i.image_bSeqno and board_DeleteDate is null order by board_Seqno desc";
	}
